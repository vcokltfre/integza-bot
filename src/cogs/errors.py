...
class ErrorHandler(commands.Cog):
    ...
    async def user_input_error(self, ctx: commands.Context, error: errors.UserInputError):
    ...
    @staticmethod
    async def check_failure(ctx: commands.Context, e: errors.CheckFailure) -> None:
